...
- (void)updateDetailsCell:(DDTextViewTableViewCell*)cell
{
    ...
    //set placeholder
    cell.textView.placeholder = [NSString stringWithFormat:NSLocalizedString(@"Enter your message to %@ & %@. Here is your chance to be unique and make a good first impression.", nil), doubleDate.user.firstName, doubleDate.wing.firstName];
}
