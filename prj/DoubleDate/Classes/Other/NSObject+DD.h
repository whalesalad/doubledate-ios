...
#define DD_F_HEADER_MAIN(_X_) [_X_ setFontOfName:@"HelveticaNeue-Bold" fontSize:16 textColor:[UIColor lightGrayColor] shadowOffset:CGSizeMake(0, -1) shadowColor:[UIColor blackColor]]
#define DD_F_HEADER_DETAILED(_X_) [_X_ setFontOfName:@"HelveticaNeue" fontSize:13 textColor:[UIColor lightGrayColor] shadowOffset:CGSizeMake(0, -1) shadowColor:[UIColor blackColor]]
...
#define DD_F_BUTTON_LARGE(_X_) [_X_ setFontOfName:@"HelveticaNeue-Bold" fontSize:15 textColor:[UIColor whiteColor] shadowOffset:CGSizeMake(0, -1) shadowColor:[UIColor colorWithRed:156/255 green:20/255 blue:71/255 alpha:0.5]]
